...
| Current phase | **Phase 1 complete + go-to-market UX enhancements** (multi-page marketing website, mobile hamburger navigation, mock admin login, interactive pitch-ready flow). **Phase 2 (backend) is next.** |
| Stack (Phase 1) | Next.js 15 App Router, React 19, TypeScript, Tailwind CSS + design tokens, Lucide icons, shadcn-style reusable UI primitives |
