...
## Frontend image assets in `public/`

Current website visuals are wired to:

| Path | Use |
|---|---|
| `public/1.png` | Home hero image |
| `public/2.png` | Services hero image |
| `public/3.png` | Pricing hero image |
| `public/4.png` | Connect page hero image |
| `public/5.png` | Connect page supporting visual |
| `public/Nikhil-Goswami.png` | About page consultant image |
